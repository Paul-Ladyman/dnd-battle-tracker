...
class CreateCreatureForm extends Component {
  ...
  render() {
    ...
    <Input
        enabled
        required
        error={nameError && <span class="form--label__error"> *</span>}
      ...
      />
        ...
        {/* </div> */}
        <Input
          customClasses="create-creature-form--item__tall"
          enabled
          integer
          value={initiative}
        ...
        <Input
          enabled
          integer
          error={healthError && <span class="form--label__error"> > 0</span>}
          value={healthPoints}
        ...
        <Input
          ...
          min="1"
          max="50"
          error={multiplierError && <span class="form--label__error"> * 1 - 50</span>}
          value={multiplier}
