...
function Footer({ playerSession, error }) {
  ...
  return (
    <footer className="footer-text" role="contentinfo">
      { error &&
        <p>
          Bugs can be reported through <ExternalLink url="https://github.com/Paul-Ladyman/dnd-battle-tracker/issues/new">Github issues</ExternalLink>.
        </p>
      }
      <p>
      ...
      { !error && 
        <>
          ...
          <p>
            Feature ideas and general feedback welcome on <ExternalLink url="https://ko-fi.com/paulbod">Ko-fi</ExternalLink>. Bugs can be reported through <ExternalLink url="https://github.com/Paul-Ladyman/dnd-battle-tracker/issues/new">Github issues</ExternalLink>.
          </p>
          <Shortcuts />
        </>
      }
