...
export default function DungeonMasterTips() {
  return (
    <main className="dmtips">
      ...
      <h3 className="dmtips--title">Session Preparation</h3>
      ...
      <p>If you have a little time to prep before your session however, there are a some tricks that will help combat run even smoother!</p>
      <p className="dmtips--tip">You can add some or all of the creatures that will be involved in combat before the session starts. You can even pre-roll the initiative and health for NPCs if you&apos;d like.</p>
      ...
      <p className="dmtips--tip">Creatures can be added to or removed from the Battle at any time, even after combat has started, so no worries if you&apos;ve forgotten something.</p>
      ...
      <p className="dmtips--tip">If you need to end the session before combat has finished, the current Battle can be downloaded from the Battle Menu [<OptionsMenuIcon /> then <SaveLoadIcon /> ] and uploaded [<SaveLoadIcon load />] at the start of the next session to pick up where you left off.</p>
      ...
      <h3 className="dmtips--title">Offline Play</h3>
