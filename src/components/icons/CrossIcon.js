  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ height: '40px', width: '40px', transform }}>
      <g transform="translate(0,0)">
        <g>
          <path d="M256 16C123.45 16 16 123.45 16 256C16 388.55 123.45 496 256 496C388.55 496 496 388.55 496 256C496 123.45 388.55 16 256 16Z" fill="#882200" fillOpacity="0" />
          <path d="M256 76C355.41 76 436 156.59 436 256C436 355.41 355.41 436 256 436C156.59 436 76 355.41 76 256C76 156.59 156.59 76 256 76Z" fill="#882200" fillOpacity="0" />
