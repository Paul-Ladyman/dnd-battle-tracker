...
export default function BuyMeACoffee({ mobileOnly }) {
  ...
  return <a href="https://ko-fi.com/R5R12KANF" target="_blank" rel="noreferrer" className={className}><img height="36" style={{ border: '0px', height: '36px' }} src={src} border="0" alt="Buy Me a Coffee at ko-fi.com" /></a>;
}
